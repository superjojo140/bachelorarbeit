...
Der Designprozess beinhaltet eine intensive Kommunikation mit den Nutzern. In
dem Buch \textit{Manual on Human-Computer Interaction} betonen die Autoren die
Bedeutung der Beobachtung und genauen Beobachtung . Wenn Sie Benutzer fragen,
wie sie die Software verwenden, gibt es viele Dinge, die sie nicht erwähnen,
weil sie vergessen wurden, nicht relevant erscheinen oder Benutzer nicht
wissen, wie sie genau darüber sprechen sollen. \cite{hciHandbook}[S. 970] Daher
ist es wichtig, die Bedürfnisse, Fähigkeiten und Strategien der Nutzer direkt
im täglichen Gebrauch zu beobachten und zu analysieren. Programmierer und
Designer müssen auch die Umgebung, die Arbeitsprozesse und den Kontext des zu
entwerfenden Systems verstehen. Wir entwickeln ein System, das den Nutzern
genau den Mehrwert liefern kann, der in ihrer Situation wichtig ist. Das System
sollte sich den Arbeitsabläufen und -Prozessen der Benutzer anpassen, nicht
umgekehrt. Alan Dix macht auch sehr deutlich, dass dieser Prozess über
mehrere Iterationen ablaufen muss
