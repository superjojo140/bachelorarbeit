...
Das module zur Terminvereinbarung der Sfotawr STubegru soll auf den
Arbetsalltag der allgemienen Studienberatung der Universität Kassel angeüasst.
werden. ides soll mit Methoden des Human Centered DEsgin umgesetzt werden. Der
zentrale Bestandteil fdes HUman cetnered Design liegt auf dem engen und stetige
nAsutausch mit den Nutzenden der Systeme \todo{Quelle} Eine wichtige Methode um
einen Softwarebedarf einschäötzen zu können inst das INterview im Kontext.
Diese Methode des Human Centered desgin eigenet sich besonders zu Beginn des
Entwicklungsprozesses, da wenig Vorkenntnisse über die eingesetzte Software und
das Umfeld,. in dem die Softwar eignestze wird notwedndig sind. Die
Softwarentwikler können so einen guten Einstieg finden, um einnen Überblick zu
gewinnen weölceh Funktoinen die fertige Software am Ende unterstützen muss, in
welchem Kontext diese im tatsächlichen Arbeitsalltag benutz weerden und welche
FAktoren dien Utnzenden der Syteme beieinföussen.

\subsubsection{Kontext des Interviews}

\paragraph{Rahmenbedingungen IiK}
Aus den oben genannten Gründen wurde als erster Schritt ein Termin für ien
INterview im Kontext mit Oliver Claves \todo{Namen nennen?} vereinbart. Her
Claves ist einer von drei Mitarbeitenden der allgemienen Studienberatung der
UNiverstiät Kasssel. Zu seinen AUfgaben gehört die Betreuung der Software
Stubegru und dern Einsatz in der ABteilung studium und Lehere. Seit über sehcs
Jahren arbeitet Oliver Claves bereits gemiensam mit Heilfskräften an dem Aufbau
und der Iptmierung der Software Stubegru um den täglichen Arbeitsalltag seines
Teams optmimal zu unterstützen. \todo{Ich-Perspektive?} Ich habe mich
persänlich mit Oliver Claves in sienem Büro im Campus Center der Universität
getroffen. Dort hat er mir an seinem Schreibtisch gezeigt, wie er mit der alten
Version der Stofware BEratungstermine erstellt und vergeben kann. Herr Claves
saß vor mir und hatte mAus und Tataur in der HAnd- Ich saß hinter im auf einem
Stuhl und habe auf einem iPad Notizen mitgeschrieben. Für die DAeur von einer
Stunden hat Herr Calves mir gezeigt, wie er sdie Softwars aktuelle nutzt ,
welche Features für ihn sehr wichtig sind und an welchen Stellen noch
Verbesserungsüoptenzial besteht.

\paragraph{Detaillierter Ablauf IiK}
Am Anfang habe ich Herr Calves gebeten mir einmal zu zeigen wie er einen
BEratungstermin in der Software anlegt und vergene kann. Does ist der Workflow,
der im Arbeitsalltag amhäufigdtern vorkommt und daher eine hohe Prirität im
Design prozess hat. Herr Calves klickte sich durch dei Verschiednen
Eingabefelder um einen freien Zeitslot für einen BEratungstermin anzulegen.
Heirbei erewähnte er, das es ganz wichtig ist, dass Datum und Uhrzeit des
Beratungstermins mit weenigen Klicks über ein Date/Time picker mit der MAus
eingeben werrden könnne. EIne Datums eingabe über die Tastatur würde er nicht
bevorzugen. \todo{Screenshot} Beim EIntragen mehrere Termine wäre ses auch
besinders praktisch, dass das zuvor eingebene DAtum stehen beleibt und direkt
ein eweitere Zeitslots für den gleichen Tag angelegt werden kann, ohne dass er
nochmal extra das Datum auswählen muss. Diem eisten der Weiteren Felder sin
Dropdown Menüs, mit wenigen Elementen , Die Asuwahl der richtigen Werte kann
Oilver Claves schnell vornehmen. Bei der AUswhal des verknüpften Raume werden
beispielsweise dei Rüu,me, die mit sieenem Nutzeraccount verknüpft sind, ganz
oben in der Asuwahlliste angezeigt. Da eine Brratung in der Regel in den eingen
Röumen stattdindent ist hier eine schnelle ASuwahö für en Normalfaöö mglöich,.
In einer Spezial situation, in der eine größerer Beratungstermin beisipelsweise
in einem gemienssamen Gruppenraum statfident ist aber auch solch eine Asuwahl
mlglich. \todo{Screenshot} NAchdem der Zeitslot für den Termin angelegt ist,
wird der entsperechedne Tag in der KAlenderbersicht nun gründ hinterlegt. Dies
ist ein Zeichen für die HIlfskräfte der Erstinformation, dass an diesem Tag
noch freie Zeitslots verfügbar sind. Durhc ein Mouse-hover über den
enstpefchenden Tag in der MOntasübersicht kann man die gernauen Termine mit
NIformationen über die UHrzeit, den zustöndigen Bratenden und di eanzahl der
ferien Plätze dsehen. \todo{Screenshot} Oliver Claves erkärt mir, dass die
kompakte Monatsansicht mit den frablich hervorgehobenen Terminslots bereits
eine sehr gute Lösung ist, damit die Hilfskräfte auf einen Blick erfassen
können an welche nTgen sie den Kunden noch Beratungsgespröche anbeiten können.
Sobald alle Ülätze der Beratungstermine an einem Tag vergeben sind, wierd
dieser Im Kalender rot markliert. "So sehen Hilfskräftes sofort, dass sie hier
keinen Temrin mehr vergeben können", erklärt Herr Clavevs \todo{Zitate?}.

Soll nun ein Zeitslot tatsächlich vergeeben werden, klickt man auf den
enstperchenden Tag ini der MOantsansicht und es öffnet sich ein MOdal. Dies ist
ein Fenter, welches sich über den anderen Bildschirminhalt legt und dem Nutzer
somit deutlich anzeigt, dasss hier eine Aktion im neu geöffnet Fenster notwndig
ist. Oliver Calves zeigt mit wie die Mitarbeitenden Der Erstingformation in
deiesm Deatil-View die freien Zeitslots an die Ratsuchenden Preosnen vergeben
können. In einer Liste werrden, nach Uhzeit sprtier, alle Termine
unterienenader angezeigt. Neben jedem freine Termin steht ein Button zum Vergbe
dieses Zeitslots zur Verfügung. \todo{Screenshot} Herr Calves zeigt mir wie
eine hIlfskraft derErstinformation nun einen solchen Zeitslot vergeben könnte.
NAch KLick auf den VeragebButton klappt ein Fomrular auf, indem Name,
KOntaktdaten und Anleigen der Rastuschenden ersfasst werden können.
