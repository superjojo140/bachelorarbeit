...
Grundlagen im Hinblick auf die gewonnenen praktischen Erfahrungen zu hinterfragen und
deren Praxistauglichkeit zu diskutieren.
...
werden. Implementierungsdetails, Screenshots und Codeschnipsel
sollen in diesem Teil die Dokumentation der Umsetzung veranschaulichen. Als
letzter Aspekt dieses Kapitels soll das Feedback der Nutzenden bei
Vorstellungen von Prototypen und ersten Ergebnissen festgehalten und
aufbereitet werden. Im letzten Kapitel wird schließlich das Ergebnis des
...
schlussendlich einen Ausblick auf weitere Einsatzmöglichkeiten des Human
Centered Design und die weitere Entwicklung der Software in der Studienberatung
...
interaktiven Systemen und Software beschrieben. Die Kernthese der Methode ist,
dass die Nutzenden der Systeme im Mittelpunkt aller Entwicklungs- und
...
DEr Ansatz des HUman Centered Design setzt dieser maschinen zentrierten
...
Dieser Ansatz gewinnt in der heutigen Zeit immer größere Bedeutung. Wie Alan
...
durchführen, sind Softwaresysteme heute hochgradig interaktiv und sollen von
...
Stellung einnehmen. Es reicht nicht aus, dass eine Software korrekt
funktioniert, also alle Berechnungen und Prozesse fehlerfrei ausführen. Im
Human Centered Design liegt der Fokus auf der INteraktion zwischen dem
Nutzenden und der Maschine. Man betrachtet, wie die Nutzenden mit dem Computer
interagieren. Wie stoßen sie Prozesse an? Die Nutzenden sollen mit den Systeme
möglichst intuitiv interagieren können. Die Benutzeroberfläche der Software,
soll selbsterklärend sein, welche Funktionen auf welchem Weg erreicht werden
können

Ein essentieller Bestandteil und die INteraktion zwischen den NUtzenden und der
...
beantworten zu können müssen die NUtzenden während der Design- und
...
in das Produktdesign integriert werden.\cite{hci} Während des gesamten
...
nach einem ersten Entwicklungszyklus selten schon perfekt. Oftmals ist es
wichtig den Nutzernden erste ergebnisse zu oräsentiwere oder ihnen pRototypen
zu zeigen. Das Feedback das nutzenden hierbei geben muss dokumentiert und für
weitere Entwicklung iterationen aufgearbeitet werden. Iwe Kurosu weiter erwähnt
seht diese r zyklische Ablauf deM Human Centered Design auch in der
entsprechende ISO Norm im Fokus. \cite{kurosuHCI}
\begin{figure}[h]
...
mehrere Phasen. Nachdem geplant ist, was für ein Projekt umgesetzt werden soll
beginnt der zyklische Kreislauf des Entwicklungsprozesses. Im ersten schritt
liegt der fokus auf dem ANalysieren der situation in dem das zu entwickelnde
...
gestalten. Im zweiten Schritt geht ses darm aus den geplanten Erwartungen an
das ystem und der Abalyse des Nutzungskontexte konkrete ANforderungen zu
spezifizieren. HIerbei geht es nocht nicht darum, wie diese aroferungen
technisch umgesetzt werden könnten sonder, darum, welche Anforderungen einf
fertiges System überhaupt erfüllen soll. IM dritten Schritt geht es nun darum
diese Anforderunge tatsächlich umzusetzen und technische LÖsungen zu
...
Das setzt weder eine intensivem Austausch mit den Nutzenden des Systems voraus.
MIt dem so gewonnen Feedback kann der Prozess wieder von vorne begonnen.
Fehlende Features können auch gearbeitete werden, MIssverständliche
Schnittstellen klarer gestaltet werden und Probleme im praktischen Einsatz
minimiert werden. \cite{iso9241}

G.A. Boy unterricht in \glqq{} The Handbook of Human-Machine Interaction\grqq{}
wie wichtig es ist dem späteren Nutzenden der System eerste Prototypen und
...
eingehen auf die NUtzenden und IHren KOntext ist also auch das einbringen und
ur diskussion stellen neuer, für die nUtzenden unbekannter, Lösungsansätze von
hoher Bedeutung.\cite{HMI-HCD}

\subsection{Interview im Kontext}

Ein wesentlicher Bestandteil im Entwicklungsprozess nach den Methoden den Human
centered design ist der intensive Austausch mit den Nutzenden der Systeme. Hier
für ist es wichtig, dass Softwareentwickler und Designer von
...
hierfür die Methode des Text Interviews im Kontext benutzt werden.

Beim Interview im kontext geht es darum die Nutzenden der Systeem in genau dem
...
mit technischen Systemen. In herkömmliche INterviews begegnen sich INterviewer
und Interviewter oftmals in einer neutralen Umgebung, wie beispielsweise einem
Konferenz raum und sprechen über die Prozesse für die sich der INterviewende
interessiert. Beim Interview im Kontext geht es nicht darum über einen Prozess
...
über das System spricht. Spricht man mit Nutzenden darüber wie sie eine
software bedienen, gibt es möglicherweise viele Dinge, die sie nicht
...
ihrer Arbeit nachgehen und mit den Systemen interagieren. Die Rolle des
Interviewenden ist dabei aus einer beobachtenden Perspektive zu verstehen. Der
Interviewte sollen die Richtung bestimmen, in die sich das Interview
...
und Emotionen des Nutzenden zu erfragen, die er während der INteraktion mit dem
System empfindet.
...
entwickelnde System zu formulieren.
