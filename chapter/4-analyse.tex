...
Als erster Schritt wurde ein Termin für ein Interview im Kontext mit \ipName\footnote{Aufgrund des Datenschutzes wurde der Name anonymisiert} vereinbart. \ipName ist einer von drei
...
entsprechenden Tag in der Monatsansicht und es öffnet sich ein \gls{Modal}. Dies ist
...
Detail-\gls{View} die freien Zeitslots an die ratsuchenden Personen vergeben können.
...
ausgetauscht, die durch die Bibliothek \gls{fullcalendar} gerendert wird.
