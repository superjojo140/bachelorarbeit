...
Iterationen. Mit einem durchgeführten Usertest sollte der Entwicklungsprozess
noch nicht als abgeschlossen gelten. Die herausgearbeiteten Kritikpunkte und
Verbesserungsvorschläge, die sich aus dem Usertest ergeben haben, sollten
...
zweiten Durchlaufes nach dem Usertest exemplarisch präsentiert:
...
hinterfragt werden. Die Ergebnisse der Usertests sollen hierbei mit
...
korrigiert werden können. Da das Ergebnis des Usertests in diesem Fall
allerdings sehr positiv ausgefallen ist, gab es sowieso nicht mehr viel
Änderungsbedarf. Wären beim Usertest noch größere Unstimmigkeiten aufgefallen
...
für Missverständnisse oder größere Änderungswünschen im Usertest senkt.
